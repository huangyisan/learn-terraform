...
module "vpc" {
  ...
  private_subnets = slice(var.private_subnets_cidr_blocks, 0, var.private_subnets_count)
  public_subnets  = slice(var.public_subnets_cidr_blocks, 0, var.public_subnets_count)
